...
namespace BUS
{
    public class BUS_DeTai
    {
        ...
        // Thêm Đề tài mới
        public void AddDeTai(string maDT, string tenDT, string chuNhiem, long kinhPhi)
        {
        ...
        public void UpdateDeTai(string maDT, string tenDT, string chuNhiem, long kinhPhi)
        {
            DTO_DeTai dt = new DTO_DeTai(maDT, tenDT, chuNhiem, kinhPhi);
